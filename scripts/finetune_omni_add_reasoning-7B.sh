...
LR=2e-5
for TRAIN_EPOCHS in 1
do


    for MODEL_BASE_NAME in HumanOmni
    do
        TRAIN_CONCEPT=0525-EMER-MERR # DFEW-MAFW-GPT-REASON-FINE-EMOTION-EMER-balance
        ...
        MODEL_NAME=StarJiaxing/${MODEL_BASE_NAME}-7B # StarJiaxing/R1-Omni-0.5B
        OUTP_DIR=work_dirs
