...
LR=2e-5
DATASET_NAME=emer
CONFIG_NAME=emotion_${DATASET_NAME}.yaml
CURRENT_TIME=$(date +"%m-%d-%H%M")
# /mnt/ssd_hs/Dataset/R1-Omni/cold_start/EMER/EMER_cold_start.json

for TRAIN_EPOCHS in 10
do
    for MODEL_BASE_NAME in HumanOmni
    do
        TRAIN_CONCEPT=${CURRENT_TIME}-${DATASET_NAME}
