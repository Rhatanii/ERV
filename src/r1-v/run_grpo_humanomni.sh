...
OUTPUT_DIR=/mnt/ssd_hs/Exp/R1-Omni/src/r1-v/results-0417
MODEL_DIR=StarJiaxing/HumanOmni-0.5B
DATA_SRC=/mnt/ssd_hs/Dataset
DATASET_NAME=/mnt/ssd_hs/Dataset/R1-Omni/EMER_cold_start.json
# /mnt/ssd_hs/Dataset/R1-Omni/RLVR.json #${DATA_SRC}/AffectGPT/EMER
