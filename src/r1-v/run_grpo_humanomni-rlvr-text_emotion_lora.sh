...
LR=1e-6
LR_SCHEDULER=cosine
MODEL_NAME=/mnt/ssd_hs/Exp/R1-Omni/work_dirs/humanomniqwen2_siglip/finetune_0525-EMER-MERR-HumanOmni-EPOCH5-LR2e-5-mm_language_model,mm_mlp_adapter,audio_projector,mm_vision_tower
...
RUN_CONCEPT="0607-acc-format-HumanOmn-RLVR-fr8-lora64"
# "0605-acc-format-EMER-MERR-SFT-RLVR-fr8-lora64"
