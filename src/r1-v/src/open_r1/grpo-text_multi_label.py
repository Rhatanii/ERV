...
from transformers import Qwen2VLForConditionalGeneration, AutoTokenizer, DataCollatorWithPadding, AutoModelForSequenceClassification

from math_verify import parse, verify
from utils import  match_emotion_key_DFEW, match_emotion_key_MAFW, match_emotion_EMOBERT
from utils_reward import think_reward, think_step_reward, think_half_reward, think_top1_reward, think_with_hint_reward, think_confusion_reward, think_emotion_label_reward, think_step_with_neutral_reward, chain_reward, accuracy_reward, consistency_reward
...
class GRPOScriptArguments(ScriptArguments):
    ...
    reward_funcs: list[str] = field(
        default_factory=lambda: ["accuracy", "format", "think", "chain", "think_confusion", "think_step", "think_top1", "think_step_with_neutral"],
