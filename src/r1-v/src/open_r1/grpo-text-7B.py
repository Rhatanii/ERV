...
from open_r1.trainer import Qwen2VLGRPOTrainer, Qwen2VLGRPOVLLMTrainer, HumanOmniVLGRPOTrainer, HumanOmniVLGRPO_TEXT_Trainer, HumanOmniVLGRPO_TEXT_Trainer_7B
...
_EMOTION_MODEL_ID ="/mnt/ssd_hs/Exp/R1-Omni/src/text_emotion_classifier/emotion_trainer-MAFW-EMER-MERR-optimizer-datadata/total_merged_-epoch10-bs64-lr0.0002/checkpoint-168"
# "/mnt/ssd_hs/Exp/R1-Omni/src/text_emotion_classifier/emotion_trainer-MAFW-EMER-MERR-optimizer-datadata/merged_-epoch10-bs64-lr0.0001/checkpoint-240" #"SamLowe/roberta-base-go_emotions"
...
def main(script_args, training_args, model_args):
   ...
   # dataset = load_dataset(script_args.dataset_name, name=script_args.dataset_config)
    ...
    trainer_cls = HumanOmniVLGRPO_TEXT_Trainer_7B 
