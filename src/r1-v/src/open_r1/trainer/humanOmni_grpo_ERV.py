...
def get_video_duration(video_path):
    """Get the duration of the video based on the video path"""
    try:
...
class HumanOmniERVGRPOTrainer(Trainer):
    """
       ...
       # import ipdb;ipdb.set_trace()
        ...
        if isinstance(model, str):
            ...
            model = VLLMs["HumanOmni_qwen2"].from_pretrained(
                ...
                low_cpu_mem_usage=False,  #device_map="auto", 
                cache_dir=None,
    ...
    def create_model_card(
        ...
        citation = textwrap.dedent(
            """\
            @article{rha2025emotion,
                title        = {{Emotion-Coherent Reasoning for Multimodal LLMs via Emotional Rationale Verifier}},
                author       = {Hyeongseop Rha, Jeong Hun Yeo, Yeonju Kim, Yong Man Ro},
                year         = 2025,
                eprint       = {arXiv:2510.23506},
            """
        )
        ...
        model_card = generate_model_card(
            ...
            paper_title="Emotion-Coherent Reasoning for Multimodal LLMs via Emotional Rationale Verifier",
            paper_id="2510.23506",
        )
