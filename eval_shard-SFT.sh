...
MODEL_PATH_ABBR_LIST=("finetune_10-31-1828-emer_AU01_w_table_info-bs32-gradaccum1-HumanOmni-EPOCH5-LR2e-5-mm_language_model,mm_mlp_adapter,audio_projector,mm_vision_tower/checkpoint-55")
DATA_LIST=("MAFW" "DFEW")
LABEL_LIST=("false")
