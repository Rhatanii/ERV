...
MODEL_PATH_ABBR_LIST=("Ablation_TS_only_MIGR/checkpoint-1000")
# R1-7B: results-0726-EMER-SFT-ACC-FORMAT-7B-epoch2-ratio1.0-grpo4-lr1e-6
# ERV-7B: results-0805-EMER-SFT-THINK_step-7B-epoch2-ratio1.0-grpo4-lr1e-6
# M-ERV-7B: results-11-08-AV_FORMAT_ACC_TSA_ep2-G4-lr1e-6_bs1_ga2_b0.04/checkpoint-1050
